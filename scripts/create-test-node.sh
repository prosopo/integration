...
# DAPP_CONTRACT_ARGS_PROTOCOL_CONTRACT_ADDRESS
grep -q "^DAPP_CONTRACT_ARGS_PROTOCOL_CONTRACT_ADDRESS=.*" "$ENV_FILE" && sedi -e "s/^DAPP_CONTRACT_ARGS_PROTOCOL_CONTRACT_ADDRESS=.*/DAPP_CONTRACT_ARGS_PROTOCOL_CONTRACT_ADDRESS=$PROTOCOL_CONTRACT_ADDRESS/g" "$ENV_FILE"
